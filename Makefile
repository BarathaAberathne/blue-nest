.PHONY: all build run dev test lint install clean \
        ...
        mongo-shell setup \
        seed seed-products seed-branches seed-catalogue seed-users seed-children seed-staff seed-daily seed-all \
        wait-api \
...
docker-up docker-restart docker-build seed-products seed-branches seed-catalogue seed-children seed-staff seed-daily seed-all: _guard-not-prod
...
seed-all: seed-products seed-branches seed-catalogue seed-users seed-children seed-staff seed-daily
