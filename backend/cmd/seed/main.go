...
var products = []models.Product{
	// ── Holiday Club Harrow ───────────────────────────────────────────────────
	{
		...
		ImageURL:    img("holiday-club-harrow-9am-4pm.jpg"),
		ImageURLs:   []string{img("holiday-club-harrow-9am-4pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
	...
	},
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-harrow-8am-6pm.jpg"),
		ImageURLs:   []string{img("holiday-club-harrow-8am-6pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
		BranchSlugs: []string{"harrow"},
	},
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-harrow-1pm-6pm.jpg"),
		ImageURLs:   []string{img("holiday-club-harrow-1pm-6pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
		BranchSlugs: []string{"harrow"},
	},
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-harrow-8am-1pm.jpg"),
		ImageURLs:   []string{img("holiday-club-harrow-8am-1pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
		BranchSlugs: []string{"harrow"},
	...
	// ── Holiday Club Pinner ───────────────────────────────────────────────────
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-pinner-9am-4pm.jpg"),
		ImageURLs:   []string{img("holiday-club-pinner-9am-4pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
	...
	},
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-pinner-8am-6pm.jpg"),
		ImageURLs:   []string{img("holiday-club-pinner-8am-6pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
		BranchSlugs: []string{"pinner"},
	},
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-pinner-1pm-6pm.jpg"),
		ImageURLs:   []string{img("holiday-club-pinner-1pm-6pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
		BranchSlugs: []string{"pinner"},
	},
	{
		...
		Currency:    "gbp",
		Category:    "Holiday Club",
		ImageURL:    img("holiday-club-pinner-8am-1pm.jpg"),
		ImageURLs:   []string{img("holiday-club-pinner-8am-1pm.jpg")},
		StockQty:     999,
		ReorderPoint: 100,
		IsActive:    true,
		BranchSlugs: []string{"pinner"},
