...
var PermissionCatalogue = []PermissionInfo{
	...
	{PermDailyLogsApprove, "Approve daily logs (four-eyes review)", "Children"},
	{PermSendManage, "SEND / additional-support profiles", "Children"},
	{PermStaffManage, "Manage staff & rota", "Staff"},
	{PermLeaveApprove, "Approve staff leave requests", "Staff"},
	...
	{PermFinanceManage, "Manage family finance (charges, payments, schedules)", "Finance"},
	{PermFinanceAdjust, "Finance adjustments (credits, refunds, write-offs)", "Finance"},
