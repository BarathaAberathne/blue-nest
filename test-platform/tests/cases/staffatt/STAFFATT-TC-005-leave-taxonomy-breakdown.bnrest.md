...
{ "staff_id": "${staff.body.data.id}", "date": "2027-04-20", "status": "sick" }
Then AssertStatus m1 200
And Get /api/v1/admin/staff-attendance/summary?date=2027-04-20&branch=${branch.slug} Into s1 Using adminSession.accessToken
...
{ "staff_id": "${staff.body.data.id}", "date": "2027-04-20", "status": "dependant_sick" }
Then AssertStatus m2 200
And Get /api/v1/admin/staff-attendance/summary?date=2027-04-20&branch=${branch.slug} Into s2 Using adminSession.accessToken
...
{ "staff_id": "${staff.body.data.id}", "date": "2027-04-20", "status": "maternity" }
Then AssertStatus m3 200
And Get /api/v1/admin/staff-attendance/summary?date=2027-04-20&branch=${branch.slug} Into s3 Using adminSession.accessToken
...
{ "staff_id": "${staff.body.data.id}", "date": "2027-04-20", "status": "unpaid_leave" }
Then AssertStatus m4 200
And Get /api/v1/admin/staff-attendance/summary?date=2027-04-20&branch=${branch.slug} Into s4 Using adminSession.accessToken
