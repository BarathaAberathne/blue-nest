          ...
          return (
            <div key={day} className="overflow-hidden rounded-[0.9rem] border border-[rgba(90,74,66,0.08)] bg-white/70">
              <button type="button" onClick={() => setExpanded(open ? null : day)}
                ...
                <ChevronDown className={`h-3.5 w-3.5 text-[#cf7d9c] transition-transform ${open ? "rotate-180" : ""}`} />
              </button>
              {open && (
              ...
              >
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                            ...
                            {BRANCHES.map((b) => (
                              <label key={b} className="flex cursor-pointer items-center gap-1.5">
                                ...
                                <span className="flex items-center gap-1 text-xs font-semibold text-[var(--ink)]">
                                  <MapPin className="h-2.5 w-2.5 text-[#ef8cab]" />{b}
                                </span>
                              </label>
                            ))}
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <label className={labelCls}>Child&rsquo;s name<Req /></label>
                            <input type="text" required placeholder="e.g. Emma" className={inputCls} />
                          </div>
                          <div>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <input type="text" required placeholder="Sarah Johnson" className={inputCls} />
                          </div>
                          <div>
                            <label className={labelCls}>Email<Req /></label>
                            <input type="email" required placeholder="sarah@email.com" className={inputCls} />
                          </div>
                        </div>
                        <div>
                          <label className={labelCls}>Phone<Req /></label>
                          <input type="tel" required placeholder="07700 900000" className={inputCls} />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <label className={labelCls}>Settling-in week<Req /></label>
                            <input type="date" required className={inputCls} />
                          </div>
                          <div>
                            <label className={labelCls}>Waiting list if unavailable?<Req /></label>
                ...
                <div className="mt-6 border-t border-[rgba(90,74,66,0.07)] pt-5">
                  {attempted && (!branch || !waitingList || !hasSignature) && (
                    <p className="mb-3 text-center text-[0.7rem] font-semibold text-[#e8719a]">
