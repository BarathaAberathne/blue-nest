...
const staticRoutes: { url: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { url: "/games/forest-school-treasure-hunt", priority: 0.5, changeFrequency: "yearly" },
  { url: "/games/grow-your-garden",          priority: 0.5, changeFrequency: "yearly"  },
  { url: "/games/match-the-animals",         priority: 0.5, changeFrequency: "yearly"  },
