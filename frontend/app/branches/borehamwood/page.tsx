...
export const metadata: Metadata = { title: "Blue Nest Montessori – Borehamwood" };
    ...
    <PublicLayout>
      <section className="bg-brand-700 text-white py-16">
        <div className="container-site">
          ...
          <h1 className="text-3xl sm:text-4xl font-heading font-bold mb-4">Blue Nest Montessori – Borehamwood</h1>
          <p className="text-brand-100 max-w-xl leading-relaxed">
            A vibrant Montessori nursery in Borehamwood, fostering curiosity and independence through child-led learning.
          </p>
        </div>
      </section>
      ...
      <SectionWrapper>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="card p-6">
            ...
            <p className="text-sm text-gray-600">Borehamwood, Hertfordshire, WD6</p>
          </div>
          <div className="card p-6">
            <h2 className="font-heading font-semibold text-gray-900 mb-3">📞 Contact</h2>
            <p className="text-sm text-gray-600">+44 20 0000 0002</p>
            <a href="mailto:borehamwood@bluenestmontessori.co.uk" className="text-sm text-brand-600 hover:underline block mt-1">
              borehamwood@bluenestmontessori.co.uk
            </a>
          </div>
          <div className="card p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Accepting children aged 3 months to 5 years. Government funding welcome including 15-hour and 30-hour free childcare.
            </p>
      ...
      <SectionWrapper>
        <div className="text-center max-w-xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">Come and see what makes our Borehamwood nursery special.</p>
