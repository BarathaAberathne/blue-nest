...
const gallery = [
  ...
  },
  {
    ...
    alt: "Children enjoying playtime together at Blue Nest Montessori Harrow",
    rotate: 2,
    caption: "Playtime together",
  },
  {
    src: "/home/branches/harrow/harrow-gallery-21.webp",
    alt: "Children learning in the Studio classroom at Blue Nest Montessori Harrow",
    rotate: -1,
    caption: "Our Studio classroom",
  },
  {
    src: "/home/branches/harrow/harrow-gallery-22.webp",
    alt: "Children gathered for a group music session at Blue Nest Montessori Harrow",
    rotate: 1,
    caption: "Group Music Sessions",
  },
  {
    src: "/home/branches/harrow/harrow-gallery-23.webp",
    alt: "A child working on early mathematics with an educator at Blue Nest Montessori Harrow",
    rotate: -2,
    caption: "Early Mathematics",
  },
  {
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <Reveal delay={0.1}>
              <div className="h-[320px] overflow-hidden rounded-[1.8rem] shadow-[0_4px_20px_rgba(90,74,66,0.10)] sm:h-[400px]">
                <BranchMapEmbed src={c.mapEmbedUrl} branchName="Harrow" />
              </div>
            </Reveal>
