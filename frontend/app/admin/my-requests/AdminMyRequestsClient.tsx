              ...
              <div key={idx} className="rounded-lg border border-gray-200 p-3">
                ...
                <div className="mt-2 grid grid-cols-12 gap-2 items-center">
                  ...
                  <input
                    ...
                    className={`${it.mode === "manual" ? "col-span-6 sm:col-span-2" : "col-span-6 sm:col-span-3"} rounded-lg border border-gray-200 px-3 py-2 text-sm`}
                  />
                  <input
                    type="number"
                    min={1}
                  ...
                  <input
                    ...
                    className={`${it.mode === "manual" ? "col-span-7 sm:col-span-4" : "col-span-7 sm:col-span-6"} rounded-lg border border-gray-200 px-3 py-2 text-sm`}
                  />
                  <button
                    type="button"
