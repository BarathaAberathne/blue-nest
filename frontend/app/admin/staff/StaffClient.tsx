...
const emptyForm: StaffInput = {
  ...
  job_title: "", staff_type: "permanent", status: "active", start_date: "", contract_hours: 40, annual_leave_days: 28, sick_leave_days: 0,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-2xl max-h-[85vh] overflow-auto rounded-xl bg-white shadow-xl">
            ...
            <div className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
              ...
              <Field label="Paid sick days (0 = uncapped)"><input type="number" min={0} value={form.sick_leave_days} onChange={(e) => setField({ sick_leave_days: Number(e.target.value) })} className="inp" /></Field>
