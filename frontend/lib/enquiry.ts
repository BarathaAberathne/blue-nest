...
> = {
  ...
  pending_confirmation: { label: ENQUIRY_STATUS_LABELS.pending_confirmation, badge: "bg-orange-100 text-orange-700", dot: "bg-orange-500" },
...
export const PIPELINE_LANES: Lane<EnquiryStatus>[] = [
  ...
  { key: "pending_confirmation", label: "Pending Confirmation", accent: "orange", statuses: ["pending_confirmation"], dropStatus: "pending_confirmation", desc: "Awaiting confirmation before registering", emptyEmoji: "⏳", emptyText: "Nothing awaiting confirmation" },
...
export const PRIMARY_ACTION: Record<EnquiryStatus, { status: EnquiryStatus; label: string } | null> = {
  ...
  visit_completed: { status: "pending_confirmation", label: "Awaiting confirmation" },
  pending_confirmation: { status: "registered", label: "Register child" },
  registered: null,
  cancelled: null,
  lost: null,
  spam: null,
